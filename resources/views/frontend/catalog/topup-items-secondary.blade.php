    ...
    @foreach ($secondary as $key => $item)
        ...
        <div class="bg-white br-7">
            <div class="row p-3 align-items-center">
                <div class="d-flex col-7 col-md-3 text-left">
                ...
                <div class="col-5 col-md-3 align-items-end d-flex flex-column align-items-end">
                ...
                <div class="col-7 d-md-none"></div>
                <div class="col-5 col-md-3 d-flex justify-content-end mt-1">
